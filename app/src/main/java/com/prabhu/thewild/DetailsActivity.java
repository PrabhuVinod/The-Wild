...
public class DetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (animalObj.getStatusCode()){
            case "lc": red_list_value_tv.setTextColor(Color.parseColor("#00A000"));
                break;
            case "nt": red_list_value_tv.setTextColor(Color.parseColor("#AFCA00"));
                break;
            case "vu": red_list_value_tv.setTextColor(Color.parseColor("#FABE00"));
                break;
            case "en": red_list_value_tv.setTextColor(Color.parseColor("#EB7800"));
                break;
            case "cr": red_list_value_tv.setTextColor(Color.parseColor("#D72800"));
                break;
            case "ew": red_list_value_tv.setTextColor(Color.GRAY);
                break;
            case "ex": red_list_value_tv.setTextColor(Color.parseColor("#191919"));
                break;
            default: red_list_value_tv.setTextColor(Color.BLACK);
                break;
        }
...
//        about_value_wv.getSettings().setLoadWithOverviewMode(true);
//        about_value_wv.getSettings().setUseWideViewPort(true);
